...
team_struct team =
{
   /* Team name:
    ...
    "5130379024", 
   /* Student name 1: Huang JunSen */
   "Huang Junsen",
   /* Login ID 1: 5130379024 */
   "5130379024",
...
int bitMask(int highbit, int lowbit) {
  int result = (~((~1) << highbit >> lowbit)) << lowbit;
  return result;
}
/* 
...
int isLess(int x, int y) {
  ...
  return ((((x + tmp + 1) & (x ^ tmp)) | (x & tmp)) >> (~(1 << 31 >> 26))) & 1;
}
/* 
